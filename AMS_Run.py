    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:\Face-Recognition-Attendance-System-main/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    #r'explorer /select,"C:/Face-Recognition-Attendance-System-main-------Check atttendance-------"')
                    r'explorer /select,"C:\Face-Recognition-Attendance-System-main\StudentDetails\StudentDetails.csv"')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:\Face-Recognition-Attendance-System-main' + fileName
    ...
    def log_in():
        ...
        if username == 'pragya':
            if password == 'pragya123':
                ...
                cs = 'C:\Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
